...
echo "Load ML modelling results"
...
echo "Create Hive table with hyperparameters info"
...
echo "Create Hive table with prediction samples"
...
echo "Create Hive table with optimization results"
...
echo "Finished loading ML results"